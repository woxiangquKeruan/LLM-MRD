...
tsne = TSNE(
    ...
    perplexity=30,            # 15
    early_exaggeration=50,    # 20
    n_iter=1000,             # 700

    learning_rate='auto', 
    init='pca', 
    random_state=42    # 方向 随机的
)
tsne_results = tsne.fit_transform(all_features)
logger.info("t-SNE 降维完成！")


# --- 视觉后处理：这里我们不再进行缩放，以保留更原始的分布 ---
# logger.info("对t-SNE结果进行视觉缩放...")
# tsne_results *= 0.7


# --- 7. 绘图 (修改版，调整了点的透明度和大小以更好地观察重叠) ---
...
# 降低 alpha 透明度，可以更清晰地看到重叠区域的颜色混合
# 适当减小点的大小 s，让分布看起来更散乱
# ================================================================
